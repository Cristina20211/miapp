...
class MainActivity : AppCompatActivity() {
    ...
    var nombre = arrayListOf<String>("Carlos", "Kemberly", "Cristina")
   ...
   for(img in imagesLista){

       myImagenLista.add(img)
   }




        gvTabla = findViewById(R.id.gvTable)
        ...
        gvTabla.onItemClickListener = object: AdapterView.OnItemClickListener{
            override fun onItemClick(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
             ...
             var ventana:Intent=Intent(application,Detalles::class.java)
